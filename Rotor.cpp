...
Rotor composeRotors(const Rotor& t_left, const Rotor& t_right)
{
	return {
			t_left.a*t_right.a - t_left.b*t_right.b - t_left.c*t_right.c - t_left.d*t_right.d,
			t_left.a*t_right.b + t_left.b*t_right.a - t_left.c*t_right.d + t_left.d*t_right.c,
			t_left.a*t_right.c + t_left.c*t_right.a - t_left.d*t_right.b + t_left.b*t_right.d,
			t_left.a*t_right.d + t_left.d*t_right.a - t_left.b*t_right.c + t_left.c*t_right.b,
		};
};
